...
router.put('/user/:user_id', auth, routeControl.userRoute, multer.upload, multer.fileControl, userCtrl.modifyOneUser); //modification du profil
router.delete('/user/:user_id', auth, admin, routeControl.userRoute, userCtrl.deleteOneUser); //Suppresion d'un profil
router.get('/user/:user_id/posts/:page/:limit', auth, routeControl.userRoute, userCtrl.getUserPosts); //Récuperation des posts d'un user
