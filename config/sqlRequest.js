...
module.exports = 
  {
    ...
    getUserRelatedMedia : 'SELECT `mediaURL` from `post` WHERE `userId` = ?',
    getUserRelatedMedia2 : 'SELECT `mediaURL` from `comment` WHERE `userId` = ?',
    ...
    getPostRelatedMedia : 'SELECT `mediaURL` from `comment` WHERE `post_id` = ?',
